...
{
    public partial class ReporteSalidaPrevia : Form
    {
        #region variables_globales
        ConsultasSQL sql = new ConsultasSQL();
        #endregion
        #region Constructor
        public ReporteSalidaPrevia()
        {
            InitializeComponent();
        }
        #endregion
        #region formload
        private void ReporteSalidaPrevia_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = sql.ObtenerReporteSalidaPrevia();
        }
        #endregion
        #region buscar buton
        private void buscar_btn_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = sql.ObtenerReporteSalidaPreviaFecha(fecha);
        }
        #endregion
